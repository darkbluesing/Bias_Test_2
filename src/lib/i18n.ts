...
export const translations = {
  ...
  en: {
    ...
    result: {
      ...
      supportButton: 'Even a single ad click\nhelps us build better features',
  ...
  es: {
    ...
    result: {
      ...
      supportButton: 'Con solo hacer clic en un anuncio\nimpulsas el desarrollo de mejores funciones',
