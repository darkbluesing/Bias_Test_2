...
export const translations = {
  ko: {
    ...
    result: {
      ...
      analysis: '분석 결과',
      solutions: '맞춤 솔루션',
      supportTitle: '광고 클릭만으로도',
      supportBody: '개발자에게는 더 좋은 앱을 개발하는데\n큰 힘이 됩니다.',
      supportCta: '광고 보러가기',
      shareButton: '결과 공유하기',
  ...
  en: {
    ...
    result: {
      ...
      supportTitle: 'Even a single ad click',
      supportBody: 'Gives the developer a big boost\nto build better features.',
      supportCta: 'Support with a click',
  ...
  es: {
    ...
    result: {
      ...
      supportTitle: 'Con solo hacer clic en un anuncio',
      supportBody: 'Das al desarrollador un gran impulso\npara seguir mejorando la app.',
      supportCta: 'Apoyar con un clic',
  ...
  zh: {
    ...
    result: {
      ...
      analysis: '分析结果',
      solutions: '个性化解决方案',
      supportTitle: '只需点击一次广告',
      supportBody: '就能大大帮助开发者\n打造更好的应用。',
      supportCta: '点击支持开发者',
      shareButton: '分享结果',
      downloadButton: '下载结果',
      retakeTest: '重新测试',
  ...
  ja: {
    ...
    result: {
      ...
      analysis: '分析結果',
      solutions: '個人別解決策',
      supportTitle: '広告をクリックするだけで',
      supportBody: '開発者がより良いアプリを作るための\n大きな力になります。',
      supportCta: 'クリックで応援する',
      shareButton: '結果をシェア',
